    ...
    <div id="create-invoices">
        <div class="row">
            <div class="col-md-3">
                ...
                <select2-ajax
                    @response="setRequestClientData($event)"
                    :url="routeFilterClients"
                    :options="[saleDataToEdit]"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.saleDataToEdit = JSON.parse(this.saleData);

            this.request.id = this.saleDataToEdit.id

            this.request.client_id = this.saleDataToEdit.client_id
            this.request.client_name = this.saleDataToEdit.client_name
            this.request.client_last_name = this.saleDataToEdit.client_last_name
            this.request.client_identity_number =this.saleDataToEdit.client_identity_number
            this.request.client_identity_type =this.saleDataToEdit.client_identity_type
            this.request.client_contact = this.saleDataToEdit.client_contact
            this.request.seller_code = this.saleDataToEdit.seller_code
            this.request.date =this.saleDataToEdit.date
            this.request.description =this.saleDataToEdit.description
            this.request.file = this.saleDataToEdit.file
            this.request.products = this.saleDataToEdit.sale_products
            this.request.payments = this.saleDataToEdit.sale_payments

            this.optionsClientContact = this.saleDataToEdit.options_client_contact
                    ...
                    .then(resp => {
                        ...
                        if (download) {
                            ...
                            axios({
                                ...
                                fileLink.setAttribute('download', resp.data.data.sale.prefix_consecutive + '.pdf');
